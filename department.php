...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO department (DeptCode, DeptID, DeptName, ForceNo) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['DeptCode'], "text"),
                       GetSQLValueString($_POST['DeptID'], "text"),
  ...
  <tr>
    <td height="165">&nbsp;
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">DeptCode:</td>
            <td><input type="text" name="DeptCode" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">DeptID:</td>
            <td><input type="text" name="DeptID" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">DeptName:</td>
            <td><input type="text" name="DeptName" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
