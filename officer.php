...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO officer (ForceNo, OfficerIDNo, OfficerName, DateOfBirth, Gender, Rank, CFN) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ForceNo'], "int"),
                       GetSQLValueString($_POST['OfficerIDNo'], "int"),
                       GetSQLValueString($_POST['OfficerName'], "text"),
  ...
  <tr>
    <td height="165">&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">ForceNo:</td>
            <td><input type="text" name="ForceNo" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">OfficerIDNo:</td>
            <td><input type="text" name="OfficerIDNo" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">OfficerName:</td>
            <td><input type="text" name="OfficerName" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Rank:</td>
            <td><input type="text" name="Rank" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">CFN:</td>
