...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO complainant (ComplainantSerialNo, ComplainantName, DateOfBIRTH, ComplainantGender, OBno) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ComplainantSerialNo'], "int"),
                       GetSQLValueString($_POST['ComplainantName'], "text"),
                       GetSQLValueString($_POST['DateOfBIRTH'], "text"),
                       GetSQLValueString($_POST['ComplainantGender'], "text"),
                       GetSQLValueString($_POST['OBno'], "text"));
  ...
  <tr>
    <td height="165">&nbsp;
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">ComplainantSerialNo:</td>
            <td><input type="text" name="ComplainantSerialNo" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">ComplainantName:</td>
            <td><input type="text" name="ComplainantName" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap align="right">ComplainantGender:</td>
            <td><input type="text" name="ComplainantGender" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">OBno:</td>
            <td><input type="text" name="OBno" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
