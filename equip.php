...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO equipment (EquipSerialNo, EquipID, BodyNO, Status, DateOfIssue, DateOfReturn, `Description`, ForceNo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['EquipSerialNo'], "int"),
                       GetSQLValueString($_POST['EquipID'], "text"),
                       GetSQLValueString($_POST['BodyNO'], "text"),
                       GetSQLValueString($_POST['Status'], "text"),
                       GetSQLValueString($_POST['DateOfIssue'], "text"),
                       GetSQLValueString($_POST['DateOfReturn'], "text"),
                       GetSQLValueString($_POST['Description'], "text"),
                       GetSQLValueString($_POST['ForceNo'], "int"));
...
<li><a href="ob.php">Add OB</a></li>
      ...
      <li><a href="equip.php" class="MenuBarItemSubmenu">Equipment</a>
        <ul>
          <li><a href="equip.php">Add equipment</a></li>
        </ul>
      </li>
  ...
  <tr>
    <td height="165">&nbsp;
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">EquipSerialNo:</td>
            <td><input type="text" name="EquipSerialNo" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">EquipID:</td>
            <td><input type="text" name="EquipID" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">BodyNO:</td>
            <td><input type="text" name="BodyNO" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap align="right">DateOfIssue:</td>
            <td><input type="text" name="DateOfIssue" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">DateOfReturn:</td>
            <td><input type="text" name="DateOfReturn" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap align="right">ForceNo:</td>
            <td><input type="text" name="ForceNo" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
