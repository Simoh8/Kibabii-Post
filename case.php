...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO casse (CFN, ChargeAndSectionOfLaw, `Result`, ComplainantSerialNo, AccSerialNo) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['CFN'], "int"),
                       GetSQLValueString($_POST['ChargeAndSectionOfLaw'], "text"),
    ...
    <td height="165">&nbsp;
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap align="right">ChargeAndSectionOfLaw:</td>
            <td><input type="text" name="ChargeAndSectionOfLaw" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">Result:</td>
            <td><input type="text" name="Result" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
